...
import TourImg02 from "../../assets/assets/images/tour-img-01.png";
import TourImg03 from "../../assets/assets/images/tour-img-02.png";
import TourImg04 from "../../assets/assets/images/tour-img-03.png";
// import TourImg05 from "../../assets/assets/images/tour-img-04.png";
import TourImg06 from "../../assets/assets/images/tour-img-05.png";
          ...
          <div className="px-6">
            ...
            <span className="flex items-center gap-2">
              ...
              <p className="text-[#757783] text-sm">
                Main Street, Thailan, Bankog
              </p>
            </span>

            <span className="text-[#757783] flex py-4">
              <FaMoneyBillWave className="text-green text-xl" /> À
  ...
  return (
    <div>
        ...
        <div className="max-w-[1320px] mx-auto lg:-mt-20 mb-10 flex flex-col lg:flex-row bg-gray-100 rounded-lg shadow-lg">
          ...
          <div className="w-full lg:w-1/2 py-24 lg:px-12 px-3">
            ...
            <h3 className="lg:text-5xl text-3xl font-bold pb-8 py-4">
              Profitez d'un accompagnement sans compromis
            </h3>
            <Accordion />
          </div>
        </div>
      ...
      <section className="container mx-auto py-12" data-aos="fade-down">
        ...
        <h3 className="lg:text-5xl text-3xl font-bold pb-8 py-4">
          Vivez un accompagnement fluide, humain et sans stress.
        </h3>
        <div>
          <Carousel
            ...
            itemClass="px-2 pb-4"
          >
            <Tour image={TourImg01} className="w-[500px] h-[360px]" name="Decouvrez Sydney Harbour Bridge (pont emblématique) en Australie" />
            <Tour image={TourImg02} className="w-[500px] h-[360px]" name="Vivez le rythme et l'ambiance Times Square  Manhattan, NY" />
            <Tour image={TourImg03} className="w-[500px] h-[360px]" name="Decouvrez Fjords de Norvège grace à Customer Assistance77" />
            <Tour image={TourImg04} className="w-[500px] h-[360px]" name="Faites votre dévoir réligieux à la Mecque et Médina" />
            <Tour image={TourImg06} className="w-[500px] h-[360px]" name="La Seine avec son eclair et son architecture unique" />
          </Carousel>
        </div>
      </section>
    </div>
